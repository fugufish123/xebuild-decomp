...
undefined4 __cdecl FUN_0041faf0(undefined4 param_1,undefined4 param_2)

{
  ...
  sprintf((char *)local_110,"MTPT%s: %s\n",param_1,param_2);
  FUN_00433690(1,"mounting %s to %s:...");
  puVar6 = local_110;
  do {
    puVar5 = puVar6;
  ...
  if ((len != pcVar4) || (_Memory = FUN_0041e800(), _Memory == (undefined *)0x0)) goto LAB_0041fb98;
  if (iStack_114 == 2) {
    sVar1 = FUN_00420ab0(_Memory);
    bVar7 = sVar1 == 0x4f4b;
    if (_Memory != &DAT_00479578) goto LAB_0041fbe0;
  }
  else {
    bVar7 = false;
    if (_Memory == &DAT_00479578) goto LAB_0041fb98;
LAB_0041fbe0:
    free(_Memory);
  }
  if (bVar7) {
