...
bool __cdecl FUN_00438860(undefined4 param_1,undefined1 *param_2,int param_3,int param_4)

{
  ...
  if ((pvVar3 == (void *)0x0) || (pvVar4 == (void *)0x0)) {
    bVar9 = false;
LAB_004388cd:
    if (puVar2 == (undefined4 *)0x0) goto LAB_004388d9;
  }
  else {
    uVar5 = FUN_0043e550((int)puVar2,(int)pvVar3,(int)pvVar4);
    bVar9 = uVar5 != 0;
    if ((param_2 == (undefined1 *)0x0) || (puVar2 == (undefined4 *)0x0)) goto LAB_004388cd;
